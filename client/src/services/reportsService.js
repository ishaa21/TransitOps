...
import { _getStubFuelLogs, _getStubExpenses } from './fuelExpenseService'
...
export const fetchAnalyticsData = async () => {
  try {
    ...
    if (shouldFallbackToStub(error)) {
      ...
      const fuelLogs = [..._getStubFuelLogs()]
      const maintenanceLogs = [..._getStubLogs()]
      const expenses = [..._getStubExpenses()]
